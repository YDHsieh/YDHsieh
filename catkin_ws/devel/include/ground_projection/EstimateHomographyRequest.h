...
// {'sensor_msgs': ['/opt/ros/indigo/share/sensor_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/indigo/share/geometry_msgs/cmake/../msg'], 'duckietown_msgs': ['/home/yard/duckietown/catkin_ws/src/duckietown_msgs/msg']}
...
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ground_projection::EstimateHomographyRequest_<ContainerAllocator>& v)
  {
    s << indent << "image: ";
    s << std::endl;
