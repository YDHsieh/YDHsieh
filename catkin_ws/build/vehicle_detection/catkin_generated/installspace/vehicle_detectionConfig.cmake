...
if("FALSE" STREQUAL "TRUE")
  set(vehicle_detection_SOURCE_PREFIX /home/yard/duckietown/catkin_ws/src/vehicle_detection)
  set(vehicle_detection_DEVEL_PREFIX /home/yard/duckietown/catkin_ws/devel)
  ...
  set(vehicle_detection_INSTALL_PREFIX /home/yard/duckietown/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vehicle_detection' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'atacchet <atacchet@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'vehicle_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yard/duckietown/catkin_ws/install/${idir}'.  Ask the maintainer 'atacchet <atacchet@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${vehicle_detection_dep}_FOUND)
      find_package(${vehicle_detection_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vehicle_detection_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND vehicle_detection_EXPORTED_TARGETS ${${vehicle_detection_dep}_EXPORTED_TARGETS})
endforeach()
