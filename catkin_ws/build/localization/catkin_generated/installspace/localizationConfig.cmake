...
if("FALSE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/yard/duckietown/catkin_ws/src/localization)
  set(localization_DEVEL_PREFIX /home/yard/duckietown/catkin_ws/devel)
  ...
  set(localization_INSTALL_PREFIX /home/yard/duckietown/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'teddy <teddy@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yard/duckietown/catkin_ws/install/${idir}'.  Ask the maintainer 'teddy <teddy@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${localization_dep}_FOUND)
      find_package(${localization_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${localization_dep} REQUIRED ${depend_list})
  endif()
