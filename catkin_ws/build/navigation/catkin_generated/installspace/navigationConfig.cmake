...
if("FALSE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/yard/duckietown/catkin_ws/src/navigation)
  set(navigation_DEVEL_PREFIX /home/yard/duckietown/catkin_ws/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/yard/duckietown/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'igor <franzoni@mit.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yard/duckietown/catkin_ws/install/${idir}'.  Ask the maintainer 'igor <franzoni@mit.edu>' to fix it.")
    endif()
...
set(navigation_EXPORTED_TARGETS "navigation_generate_messages_cpp;navigation_generate_messages_lisp;navigation_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${navigation_dep}_FOUND)
      find_package(${navigation_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${navigation_dep} REQUIRED ${depend_list})
  endif()
